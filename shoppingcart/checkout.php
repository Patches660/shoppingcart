...
<body class="bg-body-tertiary">
    ...
    <div class="container" style="margin-top: 30px;">
            ...
            <div class="row g-5">
                ...
                <div class="col-md-6 col-lg-5 order-md-last">
                    ...
                    <ul class="list-group mb-3">
                        ...
                        <?php endwhile; ?>
                        <li class="list-group-item d-flex justify-content-between bg-body-teriary">
        ...
        <!-- Add the message after completing the checkout -->
        <?php if(isset($_POST['fullname']) && isset($_POST['tel']) && isset($_POST['email']) && isset($_POST['grand_total'])): ?>
