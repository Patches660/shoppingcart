                        ...
                        <form action="<?php echo $base_url; ?>/cart-update.php" method="post">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <?php endwhile; ?>
                                    <tr>
                                        <td colspan="6" clas="text-end">
                                            <button type="submit" class="btn btn-lg btn-success">Updata Cart</button>
                                            <a href="<?php echo $base_url;?>/checkout.php"class="btn btn-lg btn-primary">Checkout Order</a>
                                        </td>
                                    </tr>
                                <?php else: ?>
                                <tr>
                                    <td colspan="6"> <h4 class="text-center text-danger">ไม่รายการสินค้าในตระกร้า</td>
                                </tr>
                                <?php endif; ?>
                            </tbody>
                     </table>
