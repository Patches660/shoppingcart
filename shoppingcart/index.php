<?php
    ...
    <body class="bg-body-tertiary">
                    ...
                    <form action="<?php echo $base_url; ?>/product-form.php" method="post" enctype="multipart/form-data">
                      <input type="hidden" name="id" value="<?php echo $result['id']; ?>">
                        ...
                        <?php if(!empty($result['profile_image'])): ?>
                            <div>
                            <img src="<?php echo $base_url; ?>/upload_image/<?php echo $result['profile_image']; ?>" style="width: 100px; height: 100px; object-fit: cover;" alt="Product Image">

                            </div>
                                <?php endif; ?>
                                <label form="formFile" class="form-label">Image</label>
                    ...
                    <div class="col-12">
                        <table class="table table-bordered border-info">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <?php if (!empty($product['profile_image'])): ?>
                                            <img src="<?php echo $base_url; ?>/upload_image/<?php echo $product['profile_image']; ?>" widtd="100" alt="Product Image">
                                        <?php else: ?>
                                            <img src="<?php echo $base_url; ?>/assets/images/no-image.png"widtd="100" alt="Product Image">
                                        <?php endif; ?> 
                                    </td>
                                    <td>
                                ...
                                <?php else: ?>
                                <tr>
                                    <td colspan="4"> <h4 class="text-center text-danger">ไม่รายการสินค้า</td>
                                </tr>
                                <?php endif; ?>
                            </tbody>
        ...
        <srcipt src="<?php echo $base_url; ?>/assets/่js/bootstrap.min.js"></script>
    </body>
    </html>